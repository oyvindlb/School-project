...
#PCA og plott i SKLEARN
#pp = PCA(n_components=7).fit_transform(model_data)
#plt.figure()
#plt.scatter(pp[:,0], pp[:,1], c=data_objNames)
#plt.show()
...
#data_varNames = list(data_df[['air_temp_set_1', 'altimeter_set_1','dew_point_temperature_set_1d', 'pressure_set_1d','relative_humidity_set_1', 'sea_level_pressure_set_1d', 'wind_speed_set_1']])




#data_df["wind_cardinal_direction_set_1d_NUMERIC"] = Le.fit_transform(data_df["wind_cardinal_direction_set_1d"])
...
print(data_df.columns)
        ...
        'wind_speed_set_1', 
        'Station_ID_NUMERIC',
        'wind_cardinal_direction_set_1d_NUMERIC'],
      dtype='object')
